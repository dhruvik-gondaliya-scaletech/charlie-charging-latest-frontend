...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen pt-32 pb-20 flex items-center overflow-hidden bg-background">
      ...
      <div className="absolute bottom-10 right-1/4 w-[600px] h-[600px] rounded-full bg-blue-500/5 blur-[150px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        >
          {/* Badge */}
          <motion.div variants={itemVariants} className="inline-flex items-center space-x-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 w-fit">
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-4 items-center">
            <Link href="#demo">
              <Button className="bg-primary text-primary-foreground hover:scale-[1.03] active:scale-[0.98] transition-all rounded-full px-8 py-6 text-sm font-bold shadow-lg shadow-primary/20 flex items-center gap-2">
                Deploy Instantly <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
            <Link href="#solutions">
              <Button variant="outline" className="border-border hover:bg-muted/50 rounded-full px-8 py-6 text-sm font-bold flex items-center gap-2">
          ...
          <motion.div 
            variants={itemVariants}
            className="grid grid-cols-2 gap-4 pt-4 border-t border-border/40 max-w-md"
          >
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center w-full">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-border bg-card/60 backdrop-blur-sm p-2 group"
          >
            <div className="absolute inset-0 bg-gradient-to-tr from-primary/5 via-transparent to-primary/5 pointer-events-none rounded-2xl" />
          ...
          <motion.div
            ...
            className="absolute top-10 -left-6 md:-left-12 bg-background/80 backdrop-blur-xl border border-border/80 rounded-xl p-4 shadow-xl flex items-center space-x-3 w-[200px]"
          >
            <div className="w-10 h-10 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-600 font-bold text-lg">
              99%
            </div>
            <div>
              <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Uptime SLA</p>
          ...
          <motion.div
            ...
            className="absolute bottom-10 -right-6 md:-right-8 bg-background/80 backdrop-blur-xl border border-border/80 rounded-xl p-4 shadow-xl flex flex-col space-y-2 w-[220px]"
          >
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">Substation load</span>
              <span className="text-xs font-bold text-primary">78% Limit</span>
            </div>
            <div className="w-full bg-muted h-2 rounded-full overflow-hidden">
              <div className="bg-primary h-full rounded-full transition-all duration-1000" style={{ width: '78%' }} />
            </div>
            <p className="text-[10px] text-muted-foreground">Dynamic Load Balancer Active</p>
          </motion.div>
        </div>
      </div>
    </section>
