            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-primary bg-primary/10 border border-primary/20 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                    {post.category}
                  </span>
                  <div className="flex items-center space-x-1 text-xs text-muted-foreground font-semibold uppercase tracking-wider">
              ...
              <div className="flex items-center justify-between mt-8 pt-4 border-t border-border/40">
                ...
                <div className="flex items-center space-x-1 text-sm font-bold text-primary group-hover:translate-x-1 transition-transform">
