      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <motion.span 
            ...
            className="inline-block py-1 px-3 bg-[#eeeeee] text-[10px] font-bold tracking-widest rounded-full mb-6 uppercase"
          >
          ...
          >
            ...
            <span className="text-[#c6c6c6]">scales with you.</span>
          </motion.h1>
          ...
          >
            <Link href={FRONTEND_ROUTES.REGISTER}>
              <Button size="lg" className="bg-black text-white px-8 py-4 h-auto rounded-xl flex items-center justify-center gap-2 font-bold transition-all hover:scale-[1.02] shadow-2xl">
                Start Free Trial
                <ArrowRight className="h-5 w-5" />
              </Button>
            </Link>
            <Link href="#demo">
              <Button variant="outline" size="lg" className="px-8 py-4 h-auto rounded-xl border-[#c6c6c6] font-bold hover:bg-[#f3f3f4] transition-all">
                Book a Demo
              </Button>
            </Link>
          </motion.div>
