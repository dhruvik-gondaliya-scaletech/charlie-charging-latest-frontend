    ...
    if (error) {
        return (
            <div className="p-12 text-center border-2 border-dashed border-destructive/20 rounded-[2rem] bg-destructive/5">
                ...
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mt-2 opacity-60">Error loading sessions for this location</p>
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-2">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground font-medium mt-1">Ledger of charging sessions across all terminals at this location</p>
                </div>
            </div>
                    ...
                    return (
                        <div className="bg-card border border-border/50 rounded-3xl p-5 space-y-4 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 py-2 border-y border-border/10">
                                ...
                                <div className="space-y-1">
                                    <p className="text-[9px] font-black uppercase text-muted-foreground tracking-widest flex items-center gap-1">
                                        <Leaf className="h-2.5 w-2.5 text-emerald-500" /> CO2 Saved
                                    </p>
                ...
                emptyState={
                    <div className="py-20 flex flex-col items-center justify-center text-center gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest mt-1">This location has processed no energy exchange in this lifecycle.</p>
                        </div>
                    </div>
                }
            />
