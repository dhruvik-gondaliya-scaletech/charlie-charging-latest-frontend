export const API_CONFIG = {
    ...
    endpoints: {
        ...
        stations: {
            create: (env: string) => `/stations/${env}`,
            base: (env: string) => `/stations/${env}`,
            stats: (env: string) => `/stations/${env}/stats`,
            byId: (env: string, id: string) => `/stations/${env}/${id}`,
            update: (env: string, id: string) => `/stations/${env}/${id}`,
            ...
            configuration: (env: string, id: string) => `/stations/${env}/${id}/configuration`,
            setConfiguration: (id: string) => `/stations/${id}/configuration`,
            ocppLogs: (id: string) => `/ocpp-logs?stationId=${id}`,
            sessions: (env: string, id: string) => `/stations/${env}/${id}/sessions`,
            chargingProfile: (id: string) => `/stations/${id}/charging-profile`,
            liveChargingProfile: (id: string) => `/stations/${id}/live-profile`,
        },
        locations: {
            create: (env: string) => `/locations/${env}`,
            base: (env: string) => `/locations/${env}`,
            byId: (env: string, id: string) => `/locations/${env}/${id}`,
            update: (env: string, id: string) => `/locations/${env}/${id}`,
            delete: (id: string) => `/locations/${id}`,
        },
        webhooks: {
            create: (env: string) => `/webhooks/${env}`,
            base: (env: string) => `/webhooks/${env}`,
            byId: (env: string, id: string) => `/webhooks/${env}/${id}`,
            update: (env: string, id: string) => `/webhooks/${env}/${id}`,
            delete: (id: string) => `/webhooks/${id}`,
            secret: (env: string, id: string) => `/webhooks/${env}/${id}/secret`,
            deliveries: (env: string) => `/webhooks/${env}/deliveries/all`,
        ...
        billing: {
            create: (env: string) => `/billing/tariffs/${env}`,
            tariffs: (env: string) => `/billing/tariffs/${env}`,
            tariffById: (env: string, id: string) => `/billing/tariffs/${env}/${id}`,
            update: (env: string, id: string) => `/billing/tariffs/${env}/${id}`,
